const Badduck = ({ width, height }) => {
    return (
        <img src="https://cdn.discordapp.com/icons/713870918786744371/a_004b97fb229a98aa9a9e5fff866ed5f8.webp?size=96" alt=" " width={width} height={height} aria-hidden="true"></img>
    )
}
const GoktugYesil = ({ width, height }) => {
    return (
        <img src="https://cdn.discordapp.com/icons/496751941863342101/df16e8b20b6b1c7d7bfaa7ebad041770.webp?size=96" alt=" " width={width} height={height} aria-hidden="true"></img>
    )
}

const DCLogo = ({width, height}) => {
    return (
...
const ServerSearch = ({width, height }) => {
    return (
        <svg aria-hidden="true" role="img" width={width} height={height} viewBox="0 0 24 24">
...
const AppDownload = ({width, height }) => {
    return (
        <svg aria-hidden="true" role="img" width={width} height={height} viewBox="0 0 24 24">
...
const DropDownButton = ({ width, height }) => {
    return (
        <svg viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" width={width} height={height}>
...
const LockIcon = ({ width, height }) => {
    return (
        <svg width={width} height={height} viewBox="0 0 24 24" aria-hidden="true" role="img">
            <path fill="currentColor" d="M17 11V7C17 4.243 14.756 2 12 2C9.242 2 7 4.243 7 7V11C5.897 11 5 11.896 5 13V20C5 21.103 5.897 22 7 22H17C18.103 22 19 21.103 19 20V13C19 11.896 18.103 11 17 11ZM12 18C11.172 18 10.5 17.328 10.5 16.5C10.5 15.672 11.172 15 12 15C12.828 15 13.5 15.672 13.5 16.5C13.5 17.328 12.828 18 12 18ZM15 11H9V7C9 5.346 10.346 4 12 4C13.654 4 15 5.346 15 7V11Z" aria-hidden="true"></path>
        </svg>
    )
}

const AnnouncementsIcon = ({ width, height }) => {
    return (
        <svg width={width} height={height} viewBox="0 0 24 24" ><path fill-rule="evenodd" clip-rule="evenodd" fill="currentColor" d="M22.545 4.87988V5.87988H23.28C23.4126 5.87988 23.52 5.98733 23.52 6.11988V10.6399C23.52 10.7724 23.4126 10.8799 23.28 10.8799H17.76C17.6275 10.8799 17.52 10.7724 17.52 10.6399V6.11988C17.52 5.98733 17.6275 5.87988 17.76 5.87988H18.52V4.87988C18.52 3.75988 19.47 2.87988 20.52 2.87988C21.57 2.87988 22.545 3.75988 22.545 4.87988ZM19.52 5.87988H21.52V4.87988C21.52 4.30845 21.0534 3.87988 20.52 3.87988C19.9867 3.87988 19.52 4.30845 19.52 4.87988V5.87988Z"></path><path fill-rule="evenodd" clip-rule="evenodd" fill="currentColor" d="M4.85 8.26429L15.84 5.84426V10.5599C15.84 11.6202 16.6996 12.4799 17.76 12.4799H21V19.0586H19.1V17.9302L12.7065 16.524L10.36 19.6233C10.1776 19.8633 9.89545 19.9998 9.6 19.9998C9.524 19.9998 9.4461 19.9904 9.3701 19.9725L5.5701 19.0313C5.1464 18.925 4.85 18.5495 4.85 18.1175V8.26429ZM9.2181 17.9942L6.75 17.3824V15.2111L10.6706 16.0751L9.2181 17.9942Z"></path><path d="M3.9 8.25981H2V15.2939H3.9V8.25981Z" fill="currentColor"></path></svg>
    )
}

const VoicIcon = ({ width, height }) => {
    return (
        <svg width={width} height={height} viewBox="0 0 24 24" ><path fill="currentColor" fill-rule="evenodd" clip-rule="evenodd" d="M15 12C15 12.0007 15 12.0013 15 12.002C15 12.553 14.551 13.002 14 13.002V15.002C15.654 15.002 17 13.657 17 12.002C17 12.0013 17 12.0007 17 12H15ZM19 12C19 12.0007 19 12.0013 19 12.002C19 14.759 16.757 17.002 14 17.002V19.002C17.86 19.002 21 15.863 21 12.002C21 12.0013 21 12.0007 21 12H19ZM10.293 3.29604C10.579 3.01004 11.009 2.92504 11.383 3.07904C11.757 3.23204 12 3.59904 12 4.00204V20.002C12 20.407 11.757 20.772 11.383 20.927C11.009 21.082 10.579 20.996 10.293 20.71L6 16.002H3C2.45 16.002 2 15.552 2 15.002V9.00204C2 8.45304 2.45 8.00204 3 8.00204H6L10.293 3.29604Z"></path><path fill="currentColor" d="M21.025 5V4C21.025 2.88 20.05 2 19 2C17.95 2 17 2.88 17 4V5C16.4477 5 16 5.44772 16 6V9C16 9.55228 16.4477 10 17 10H19H21C21.5523 10 22 9.55228 22 9V5.975C22 5.43652 21.5635 5 21.025 5ZM20 5H18V4C18 3.42857 18.4667 3 19 3C19.5333 3 20 3.42857 20 4V5Z"></path></svg>
    )
}

const RullerIcon = ({ width, height }) => {
    return (
        <svg width={width} height={height} viewBox="0 0 40 40" fill="none" class="icon-2W8DHg"><path fill="currentColor" fill-rule="evenodd" clip-rule="evenodd" d="M33 34.5833V7.49998H35V36.6666H9C6.791 36.6666 5 34.801 5 32.5V7.49998C5 5.19894 6.791 3.33331 9 3.33331H31V30.4166H9C7.8955 30.4166 7 31.3485 7 32.5C7 33.6515 7.8955 34.5833 9 34.5833H33ZM23.9718 9.99998L15.8889 17.9915L12.7086 14.8441L10 17.5058L15.8885 23.3333L26.6667 12.6669L23.9718 9.99998Z"></path></svg>
    )
}
...
const PostIcon = ({ width, height }) => {
    return (
        <svg x="0" y="0" class="icon-2xnN2Y" aria-hidden="true" role="img" width={width} height={height} viewBox="0 0 24 24" fill="none"><path d="M19 3H4.99C3.88 3 3.01 3.89 3.01 5L3 19C3 20.1 3.88 21 4.99 21H19C20.1 21 21 20.1 21 19V5C21 3.89 20.1 3 19 3ZM19 15H15C15 16.66 13.65 18 12 18C10.35 18 9 16.66 9 15H4.99V5H19V15Z" fill="currentColor"></path></svg>
    )
}

const helpIcon = ({ width, height }) => {
    return (
        <svg x="0" y="0" class="icon-2xnN2Y" aria-hidden="true" role="img" width={width} height={height} viewBox="0 0 24 24"><path fill="currentColor" d="M12 2C6.486 2 2 6.487 2 12C2 17.515 6.486 22 12 22C17.514 22 22 17.515 22 12C22 6.487 17.514 2 12 2ZM12 18.25C11.31 18.25 10.75 17.691 10.75 17C10.75 16.31 11.31 15.75 12 15.75C12.69 15.75 13.25 16.31 13.25 17C13.25 17.691 12.69 18.25 12 18.25ZM13 13.875V15H11V12H12C13.104 12 14 11.103 14 10C14 8.896 13.104 8 12 8C10.896 8 10 8.896 10 10H8C8 7.795 9.795 6 12 6C14.205 6 16 7.795 16 10C16 11.861 14.723 13.429 13 13.875Z"></path></svg>
    )
}

const ChatPlusIcon = ({ width, height }) => {
    return (
        <svg width={width} height={height} viewBox="0 0 24 24"><path class="attachButtonPlus-3IYelE" fill="currentColor" d="M12 2.00098C6.486 2.00098 2 6.48698 2 12.001C2 17.515 6.486 22.001 12 22.001C17.514 22.001 22 17.515 22 12.001C22 6.48698 17.514 2.00098 12 2.00098ZM17 13.001H13V17.001H11V13.001H7V11.001H11V7.00098H13V11.001H17V13.001Z"></path></svg>
    )
}
...
const Icon = ({ name, width, height }) => {
    const icons = {
        ...
        voicIcon: VoicIcon,
        rullerIcon: RullerIcon,
        goktugYesilpp: GoktugYesilpp,
        micIcon: MicIcon,
